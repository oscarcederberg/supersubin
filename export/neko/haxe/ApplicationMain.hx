...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("SuperSubin", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("SuperSubin", null, 1024, 960);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "31";
		app.meta["company"] = "oscarcederberg";
		app.meta["file"] = "SuperSubin";
		app.meta["name"] = "Super Subin";
